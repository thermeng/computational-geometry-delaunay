...
int main() {
    std::vector<Point> points = {
        {0.0, 5.0}, {1.5, 5.2}, {3.0, 5.5}, {4.5, 5.3}, {6.0, 5.0},
        {7.5, 4.8}, {9.0, 4.5}, {1.0, 6.5}, {2.5, 7.0}, {4.0, 6.8},
        {5.5, 6.2}, {7.0, 5.8}, {1.0, 3.5}, {2.5, 3.0}, {4.0, 3.2},
        {5.5, 3.8}, {7.0, 4.2}, {-0.5, 5.0}, {9.5, 4.5}, {3.5, 5.0},
        {5.0, 4.5}, {6.5, 5.5}
    };
